...
from train_utils.train_utils import init_distributed_mode, dist, cleanup
from train_utils.train_utils import train_one_epoch, evaluate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/vit_patch32-pre.pth',
